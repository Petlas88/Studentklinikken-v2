  ...
  template: `
        ...
        <div class="container-fluid">
            ...
            <div v-if="modalTwoVisible" id="modal-two" class="modals" v-on-clickaway="hideModal">
                <transition name="slide-up" @after-leave="modalTwoVisible= false">
                    <div v-if="overlayActive" class="modals-content">
                        <div class="modal-header">
                            <button class="modal-collapse-btn" @click="overlayActive = !overlayActive">&#10006</button>
                        </div>
            ...
            <div v-if="modalThreeVisible" id="modal-three" class="modals" v-on-clickaway="hideModal">
                <transition name="slide-up" @after-leave="modalThreeVisible= false">  
                <div v-if="overlayActive" class="modals-content">
                    <div class="modal-header">
                        <button class="modal-collapse-btn" @click="overlayActive = !overlayActive">&#10006</button>
                    </div>
            ...
            <div v-if="modalFourVisible" id="modal-four" class="modals" v-on-clickaway="hideModal">
                <transition name="slide-up" @after-leave="modalFourVisible= false">
                <div v-if="overlayActive" class="modals-content">
                    <div class="modal-header">
                        <button class="modal-collapse-btn" @click="overlayActive = !overlayActive">&#10006</button>
                    </div>
